...
public class Satellite extends Thread
{
    ...
    public Satellite(String satellitePropertiesFile, String classLoaderPropertiesFile, String serverPropertiesFile)
    {
        ...
        {
            System.err.println("Error: Satellite Property File Not Found!");
        ...
        {
            System.err.println("Error: Server Property File Not Found!");
            e.printStackTrace(System.err);
            System.exit(1);
        }
        ...
        {
            System.err.println("Error: HTTPClassLoader Property File Not Found!");
            e.printStackTrace(System.err);
            System.exit(1);
        }
    ...
    public void run()
    {
        ...
        // NO REGISTRATION INCLUDED FOR THIS ASSIGNMENT
        ...
        {
            System.err.println("[Satellite.run] Error while creating ServerSocket");
            e.printStackTrace(System.err);
        }
    }
